...
| [**DNS Parser**](https://github.com/fabriziofiorucci/ngx_stream_dns_module) | Stream module for DNS protocol parsing - also on [NGINX Demos](https://github.com/nginx/nginx-demos/tree/main/nginx/ngx_stream_dns_module) |
